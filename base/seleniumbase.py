...
class SeleniumBase:
    def __init__(self, driver):
        self.driver = driver
        self.__wait = WebDriverWait(driver, 5, 0.3, ignored_exceptions=StaleElementReferenceException)
    ...
    def get_text_from_elements(self, elements: List[WebElement])-> List[str]:
